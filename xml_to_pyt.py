...
def convert_xml(filename):
    ...
    for obj in tree.findall('object'):
        ...
        if obj_struct['name']=='fire':
            ...
            #f1.write("\n")
           # cntnf+=1
           crop_img.save("D:\\smart space lab\\testnegimg"+str(cntnf)+".jpg")
           cntnf+=1
           #crop_img.show()'''
        '''
        print (x1, y1, x2, y2)
        tree.write(filename)'''
        #print(obj_struct['name'])
        crop_img.save("D:\\machinelearning projects\\licenseplatetextdet\\ocr image data\\char"+obj_struct['name']+"\\img"+str(count[obj_struct['name']])+".jpg")
        count[obj_struct['name']] +=1
train_data="D:\\machinelearning projects\\licenseplatetextdet\\recogniserannot"      
